...
void registerListCommands(CommandRegistry& reg) {
    reg.registerCommand(
        "LPUSH", [](Database& db, int clientFd, std::vector<std::string>& args) -> std::string {
            if (args.size() < 2)
    ...
    reg.registerCommand(
        "RPUSH", [](Database& db, int clientFd, std::vector<std::string>& args) -> std::string {
            if (args.size() < 2)
    ...
    reg.registerCommand(
        "LPOP", [](Database& db, int clientFd, std::vector<std::string>& args) -> std::string {
            if (args.size() < 1)
    ...
    reg.registerCommand(
        "RPOP", [](Database& db, int clientFd, std::vector<std::string>& args) -> std::string {
            if (args.size() < 1)
    ...
    reg.registerCommand(
        "LLEN", [](Database& db, int clientFd, std::vector<std::string>& args) -> std::string {
            if (args.size() < 1)
    ...
    reg.registerCommand(
        "LINDEX", [](Database& db, int clientFd, std::vector<std::string>& args) -> std::string {
            if (args.size() < 2)
    ...
    reg.registerCommand(
        "LSET", [](Database& db, int clientFd, std::vector<std::string>& args) -> std::string {
            if (args.size() < 3)
    ...
    reg.registerCommand(
        "LRANGE", [](Database& db, int clientFd, std::vector<std::string>& args) -> std::string {
            if (args.size() < 3)
